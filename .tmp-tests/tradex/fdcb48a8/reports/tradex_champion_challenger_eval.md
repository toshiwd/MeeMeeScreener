...
- family_id: `tradex-research-dup-thesis-duplicate-family`
- baseline_run_id: `tradex-research-dup-thesis-duplicate-family-baseline`
- candidate_run_id: `tradex-research-dup-thesis-duplicate-family-duplicate-a`
- report_path: `C:/work/meemee-screener/.tmp-tests/tradex/fdcb48a8/reports/tradex_champion_challenger_eval_tradex-research-dup-thesis-duplicate-family_tradex-research-dup-thesis-duplicate-family-duplicate-a.md`
- evaluation_window_id: `fcce0fc5579dc9ec`
- regime_tag: `multi_regime`
- baseline_method_title: `現行ランキング`
- candidate_method_title: `重複候補A`
- candidate_method_family: `duplicate-family`
- promote_ready: `False`
...
- challenger_method: `重複候補A`
- challenger_family: `duplicate-family`
- challenger_thesis: `同じ仮説を試す。`
