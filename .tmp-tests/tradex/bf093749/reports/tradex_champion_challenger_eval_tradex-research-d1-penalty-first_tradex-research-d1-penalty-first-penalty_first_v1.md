...
- family_id: `tradex-research-d1-penalty-first`
- baseline_run_id: `tradex-research-d1-penalty-first-baseline`
- candidate_run_id: `tradex-research-d1-penalty-first-penalty_first_v1`
- report_path: `C:/work/meemee-screener/.tmp-tests/tradex/bf093749/reports/tradex_champion_challenger_eval_tradex-research-d1-penalty-first_tradex-research-d1-penalty-first-penalty_first_v1.md`
- evaluation_window_id: `e1a6ceb26ed94696`
- regime_tag: `multi_regime`
- baseline_method_title: `現行ランキング`
- candidate_method_title: `減点優先型`
- candidate_method_family: `penalty-first`
- promote_ready: `False`
- promote_reasons: `monthly_capture_not_improved, turnover_too_high, zero_pass_months_not_improved`
...
| monthly_top5_capture_mean | 1.0000 | 0.1000 | -0.9000 |
| zero_pass_months | 0.0000 | 1.0000 | 1.0000 |
| dd | 0.0000 | 0.0000 | 0.0000 |
| turnover | 0.0000 | 0.7500 | 0.7500 |
