...
- family_id: `tradex-research-r1-penalty-first`
- baseline_run_id: `tradex-research-r1-penalty-first-baseline`
- candidate_run_id: `tradex-research-r1-penalty-first-penalty_first_v2`
- report_path: `C:/work/meemee-screener/.tmp-tests/tradex/4c4d4806/reports/tradex_champion_challenger_eval_tradex-research-r1-penalty-first_tradex-research-r1-penalty-first-penalty_first_v2.md`
- evaluation_window_id: `fd87835f2203102a`
...
| monthly_top5_capture_mean | 1.0000 | 0.2000 | -0.8000 |
...
| --- | --- | ---: | ---: | ---: | --- |
| up:20250101:20250301 | up | 60 | 0.0450 | 0.0450 | false |
