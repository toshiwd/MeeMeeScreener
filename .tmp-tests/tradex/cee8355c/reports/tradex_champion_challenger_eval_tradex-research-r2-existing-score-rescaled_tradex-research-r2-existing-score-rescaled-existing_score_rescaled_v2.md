...
- family_id: `tradex-research-r2-existing-score-rescaled`
- baseline_run_id: `tradex-research-r2-existing-score-rescaled-baseline`
- candidate_run_id: `tradex-research-r2-existing-score-rescaled-existing_score_rescaled_v2`
- report_path: `C:/work/meemee-screener/.tmp-tests/tradex/cee8355c/reports/tradex_champion_challenger_eval_tradex-research-r2-existing-score-rescaled_tradex-research-r2-existing-score-rescaled-existing_score_rescaled_v2.md`
- evaluation_window_id: `3a918ff74b7c4922`
...
| monthly_top5_capture_mean | 1.0000 | 0.8000 | -0.2000 |
