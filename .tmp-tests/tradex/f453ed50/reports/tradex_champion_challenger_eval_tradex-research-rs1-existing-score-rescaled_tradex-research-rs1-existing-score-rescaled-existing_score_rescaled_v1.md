...
- family_id: `tradex-research-rs1-existing-score-rescaled`
- baseline_run_id: `tradex-research-rs1-existing-score-rescaled-baseline`
- candidate_run_id: `tradex-research-rs1-existing-score-rescaled-existing_score_rescaled_v1`
- report_path: `C:/work/meemee-screener/.tmp-tests/tradex/f453ed50/reports/tradex_champion_challenger_eval_tradex-research-rs1-existing-score-rescaled_tradex-research-rs1-existing-score-rescaled-existing_score_rescaled_v1.md`
- evaluation_window_id: `acfbb82530b1ea04`
...
| monthly_top5_capture_mean | 1.0000 | 0.5000 | -0.5000 |
| zero_pass_months | 0.0000 | 0.0000 | 0.0000 |
| dd | 0.0000 | 0.0000 | 0.0000 |
| turnover | 0.0000 | 0.5714 | 0.5714 |
