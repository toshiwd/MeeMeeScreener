...
- family_id: `8174f5eb8659`
- baseline_run_id: `8174f5eb8659-baseline`
- candidate_run_id: `8174f5eb8659-candidate-c`
- report_path: `C:/work/meemee-screener/.tmp-tests/tradex/ace7dc2a/reports/tradex_champion_challenger_eval_8174f5eb8659_8174f5eb8659-candidate-c.md`
- evaluation_window_id: `76a646e80a222099`
- regime_tag: `multi_regime`
- baseline_method_title: `現行ランキング`
- candidate_method_title: `候補C`
- candidate_method_family: `family-c`
- promote_ready: `False`
...
- challenger_method: `候補C`
- challenger_family: `family-c`
- challenger_thesis: `逆風時の無駄な通過を減らす。`
...
| monthly_top5_capture_mean | 1.0000 | 0.6000 | -0.4000 |
