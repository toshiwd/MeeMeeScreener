      ...
      <div className="detail-analysis-body">
        {(financialPanel?.summary?.latestFiscalYear != null || financialFetchedLabel) && (
          <div className="detail-financial-meta-row">
            ...
            {financialFetchedLabel && <div className="detail-financial-meta-pill">取得日 {financialFetchedLabel}</div>}
          </div>
        )}
        {financialLoading ? (
          ...
          <>
            ...
            <div className="detail-analysis-section detail-financial-section">
              ...
              {tdnetLoading ? (
                <div className="detail-analysis-empty">TDNET開示を確認中です。</div>
                ...
                <div className="detail-analysis-empty">TDNET開示はまだ取り込まれていません。</div>
              )}
            </div>
            <div className="detail-analysis-section detail-financial-section">
              ...
              {taisyakuLoading ? (
                <div className="detail-analysis-empty">貸借データを確認中です。</div>
                  ...
                  {taisyakuRestrictions.length > 0 && (
                    <div className="detail-financial-taisyaku-alerts">
                      {taisyakuRestrictions.map((item, index) => (
                        ...
                        >
                          <span className="detail-financial-tdnet-pill">{item.measureType ?? "制限措置"}</span>
                ...
                <div className="detail-analysis-empty">貸借データはまだ取り込まれていません。</div>
              )}
            </div>
            {hasFinancialSeries && (
              <>
