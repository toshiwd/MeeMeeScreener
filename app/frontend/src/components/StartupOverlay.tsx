    ...
    <div className={`startup-overlay ${visible ? "is-visible" : "is-hidden"}`}>
      ...
      <div className="startup-card" role="status" aria-live="polite">
        <div className="startup-brand">
          ...
          <div className="startup-brand-name">
            MeeMee<span className="startup-brand-accent"> Screener</span>
          </div>
        </div>

        <div className="startup-status">
          <div className="startup-status-text">{isError ? "起動エラー" : subtitle}</div>
          {!isError && (
            <>
              ...
              <div className="startup-meta">試行 {attemptCount} 回 経過 {elapsedSeconds}s</div>
            </>
          )}
        </div>
