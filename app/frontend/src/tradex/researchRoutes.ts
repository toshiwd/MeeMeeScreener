...
export const TRADEX_RESEARCH_ENDPOINTS = {
  ...
  forecastSurfaceReview: "/forecast-surface-review",
  shortLifecycleBoard: "/short-lifecycle-board",
  buyLifecycleBoard: "/buy-lifecycle-board",
  shapeEntryBoard: "/shape-entry-board",
  adaptiveRuleBoard: "/adaptive-rule-board",
  integratedEntryBoard: "/integrated-entry-board",
