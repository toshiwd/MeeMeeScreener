...
SERVICE_NAME = "MeeMeeScreener.EDINET"


@dataclass(frozen=True)
class EdinetSecretRef:
    credential_name: str
...
class WindowsCredentialStore(EdinetSecretStore):
    ...
    def _target(self, credential_name: str) -> EdinetSecretRef:
        return EdinetSecretRef(credential_name=str(credential_name or "").strip() or "default")
...
def get_default_edinet_secret_store() -> EdinetSecretStore:
