...
- family_id: `tradex-research-scope-e1feaec6e0a3-seed-7-existing-score-rescaled`
- baseline_run_id: `tradex-research-scope-e1feaec6e0a3-seed-7-existing-score-rescaled-baseline`
- candidate_run_id: `tradex-research-scope-e1feaec6e0a3-seed-7-existing-score-rescaled-existing_score_rescaled_v1`
- report_path: `C:/work/meemee-screener/docs/reports/tradex_champion_challenger_eval_tradex-research-scope-e1feaec6e0a3-seed-7-existing-score-rescaled_tradex-research-scope-e1feaec6e0a3-seed-7-existing-score-rescaled-existing_score_rescaled_v1.md`
- evaluation_window_id: `923789931fa9bf7c`
