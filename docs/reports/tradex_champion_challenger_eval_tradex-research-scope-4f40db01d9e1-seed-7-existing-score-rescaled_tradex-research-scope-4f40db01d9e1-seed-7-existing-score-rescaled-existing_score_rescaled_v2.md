...
- family_id: `tradex-research-scope-4f40db01d9e1-seed-7-existing-score-rescaled`
- baseline_run_id: `tradex-research-scope-4f40db01d9e1-seed-7-existing-score-rescaled-baseline`
- candidate_run_id: `tradex-research-scope-4f40db01d9e1-seed-7-existing-score-rescaled-existing_score_rescaled_v2`
- report_path: `C:/work/meemee-screener/docs/reports/tradex_champion_challenger_eval_tradex-research-scope-4f40db01d9e1-seed-7-existing-score-rescaled_tradex-research-scope-4f40db01d9e1-seed-7-existing-score-rescaled-existing_score_rescaled_v2.md`
- evaluation_window_id: `d41a4f11ab10b6c1`
