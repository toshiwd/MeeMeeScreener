...
- family_id: `tradex-research-scope-e1feaec6e0a3-seed-7-penalty-first`
- baseline_run_id: `tradex-research-scope-e1feaec6e0a3-seed-7-penalty-first-baseline`
- candidate_run_id: `tradex-research-scope-e1feaec6e0a3-seed-7-penalty-first-penalty_first_v1`
- report_path: `C:/work/meemee-screener/docs/reports/tradex_champion_challenger_eval_tradex-research-scope-e1feaec6e0a3-seed-7-penalty-first_tradex-research-scope-e1feaec6e0a3-seed-7-penalty-first-penalty_first_v1.md`
- evaluation_window_id: `0bf710008102571a`
