...
- random_seed: `7`
- manifest_hash: `8e4c2c926803f6c84a9ef9142b34008ed96a424fa6341ea31ce373e6e8fb9515`
...
| ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 30 | 10 | 9 | 9 | 9 | 9 | 9 | 89 | false |
- first_zero_stage: `passed`
- failure_stage: `passed`
- future_ret20: candidate_day_count=`801`, passed_count=`801`, guarded_out_count=`0`
- future_ret20_failure_reason_counts: `{"ret20_source_missing": 261}`
- ret20_source_mode: `precomputed`
...
- future_ret20_join_gap_coverage: `{"after_scope_filter_count": 522, "candidate_rows_after_scope_filter": 1602, "candidate_rows_before_scope_filter": 18000, "examples": [], "future_rows_after_scope_filter": 187866, "future_rows_before_scope_filter": 3001932, "joinable_code_date_pairs_after_scope": 3204, "joinable_code_date_pairs_before_scope": 36000, "reason_counts": {}}`
...
- run_id: `tradex-research-scope-43d5e1d38840-seed-7-champion-baseline`
...
- 名前: `逆風回避の順張り`
  ...
  - 強い局面: `evaluation_summary.windows` を参照
  - 弱い局面: `evaluation_window_coverage_incomplete, evaluation_windows_unavailable, market_regime_daily_unavailable:IOException, no_evaluation_windows, regime_rows_empty`
  - champion との差分: `0.0000`
...
- status: `trained`
- ranked_candidates:
  - `既存点数の再尺度化` score=`0.8889` promote=`True`
  - `既存点数の再尺度化強め` score=`0.8889` promote=`True`
  - `流動性ふるい残し` score=`0.8889` promote=`True`
  - `減点優先型` score=`0.8889` promote=`True`
  - `減点優先型厳しめ` score=`0.8889` promote=`True`
