...
- family_id: `tradex-research-scope-0b782cdf2c61-seed-29-penalty-first`
- baseline_run_id: `tradex-research-scope-0b782cdf2c61-seed-29-penalty-first-baseline`
- candidate_run_id: `tradex-research-scope-0b782cdf2c61-seed-29-penalty-first-penalty_first_v2`
- report_path: `C:/work/meemee-screener/docs/reports/tradex_champion_challenger_eval_tradex-research-scope-0b782cdf2c61-seed-29-penalty-first_tradex-research-scope-0b782cdf2c61-seed-29-penalty-first-penalty_first_v2.md`
- evaluation_window_id: `975c677482f29cac`
- regime_tag: `multi_regime`
- baseline_method_title: `現行ランキング`
- candidate_method_title: `減点優先型厳しめ`
...
- challenger_method: `減点優先型厳しめ`
- challenger_family: `penalty-first`
- challenger_thesis: `さらに閾値を上げて、弱い候補を上位に残しにくくする。`
