...
- session_id: `scope-d857a869ae22-seed-23`
- session_scope_id: `rr_confirmed_20260323_fix5_regime_shift`
- random_seed: `23`
- manifest_hash: `833d5e831e0b1894d6211a9fae57b0c77c8e70c8ca979c737f43a7b0d627697e`
...
- future_ret20_failure_reason_counts: `{"ret20_source_missing": 270}`
- ret20_source_mode: `precomputed`
...
- future_ret20_join_gap_coverage: `{"after_scope_filter_count": 540, "candidate_rows_after_scope_filter": 0, "candidate_rows_before_scope_filter": 0, "examples": [], "future_rows_after_scope_filter": 51732, "future_rows_before_scope_filter": 3246588, "joinable_code_date_pairs_after_scope": 0, "joinable_code_date_pairs_before_scope": 0, "reason_counts": {}}`
...
- run_id: `tradex-research-scope-d857a869ae22-seed-23-champion-baseline`
...
- 名前: `減点優先型`
  ...
  - 弱い局面: `none`
  - champion との差分: `0.0000`
| readiness-aware | 準備完了優先型強め | 0.0000 | 0.0000 | 0.0000 | true |
- 名前: `準備完了優先型強め`
  - 仮説: `ready率への寄せをさらに強めて、零通過月を減らしにいく。`
  - 強い局面: `evaluation_summary.windows` を参照
  - 弱い局面: `none`
  - champion との差分: `0.0000`
