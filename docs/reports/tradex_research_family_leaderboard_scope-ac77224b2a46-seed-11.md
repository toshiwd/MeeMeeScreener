...
- random_seed: `11`
- generated_at: `2026-03-24T00:25:11.813814+00:00`
...
- source_compare_path: `C:\work\meemee-screener\.tmp-tradex-fix\research_sessions\scope-ac77224b2a46-seed-11\compare.json`
- source_report_path: `C:\work\meemee-screener\docs\reports\tradex_research_session_scope-ac77224b2a46-seed-11.md`
...
| --- | --- | ---: | ---: | ---: | --- |
| existing-score rescaled | hold | 0 | 0 | 0 |  |
- `existing-score rescaled` decision_reasons: `[{"code": "additional_candidate_worth_trying", "hold_count": 1}]`
| liquidity-aware | keep | 1 | 0 | 0 | 流動性ふるい残し厳しめ |
...
| regime-aware | 逆風回避の順張り | drop | precomputed | 0.0000 | 0.0000 | 0.0000 | 0 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | top5:pass, top10:pass, monthly_capture:fail, zero_pass:pass, worst_regime:pass, dd:pass, turnover:pass, liquidity_fail:pass |
