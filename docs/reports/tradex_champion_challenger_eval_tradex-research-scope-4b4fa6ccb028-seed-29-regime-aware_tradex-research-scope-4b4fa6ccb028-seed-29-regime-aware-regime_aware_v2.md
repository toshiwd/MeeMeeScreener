...
- family_id: `tradex-research-scope-4b4fa6ccb028-seed-29-regime-aware`
- baseline_run_id: `tradex-research-scope-4b4fa6ccb028-seed-29-regime-aware-baseline`
- candidate_run_id: `tradex-research-scope-4b4fa6ccb028-seed-29-regime-aware-regime_aware_v2`
- report_path: `C:/work/meemee-screener/docs/reports/tradex_champion_challenger_eval_tradex-research-scope-4b4fa6ccb028-seed-29-regime-aware_tradex-research-scope-4b4fa6ccb028-seed-29-regime-aware-regime_aware_v2.md`
- evaluation_window_id: `5fa84d833613d141`
- regime_tag: `multi_regime`
- baseline_method_title: `現行ランキング`
- candidate_method_title: `逆風回避の順張り保守`
- candidate_method_family: `regime-aware`
- promote_ready: `True`
...
- challenger_method: `逆風回避の順張り保守`
- challenger_family: `regime-aware`
- challenger_thesis: `順張り寄りを少し強めて、弱い局面の候補を落としやすくする。`
