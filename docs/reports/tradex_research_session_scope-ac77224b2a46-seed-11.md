...
- session_id: `scope-ac77224b2a46-seed-11`
- session_scope_id: `rr_confirmed_20260323_fix5_regime_shift`
- random_seed: `11`
- manifest_hash: `09479aa4661440ddef0f8a0a3b707ed0b2e0ddb0138dacb0d71fb0191a18eca1`
...
- future_ret20_failure_reason_counts: `{"ret20_source_missing": 180}`
- ret20_source_mode: `precomputed`
...
- future_ret20_join_gap_coverage: `{"after_scope_filter_count": 360, "candidate_rows_after_scope_filter": 0, "candidate_rows_before_scope_filter": 0, "examples": [], "future_rows_after_scope_filter": 33012, "future_rows_before_scope_filter": 2097924, "joinable_code_date_pairs_after_scope": 0, "joinable_code_date_pairs_before_scope": 0, "reason_counts": {}}`
...
- run_id: `tradex-research-scope-ac77224b2a46-seed-11-champion-baseline`

## Families

| family | best method | top5 mean | median | monthly capture | promote |
| --- | --- | ---: | ---: | ---: | --- |
| existing-score rescaled |  | 0.0000 | 0.0000 | 0.0000 | false |
- 名前: ``
  - 仮説: ``
...
- 名前: `準備完了優先型`
  ...
  - 弱い局面: `none`
  - champion との差分: `0.0000`
| liquidity-aware | 流動性ふるい残し厳しめ | 0.0000 | 0.0000 | 0.0000 | true |
- 名前: `流動性ふるい残し厳しめ`
  - 仮説: `流動性への寄せを強めて、上位に買いにくい銘柄を残しにくくする。`
  - 強い局面: `evaluation_summary.windows` を参照
  - 弱い局面: `none`
  - champion との差分: `0.0000`
