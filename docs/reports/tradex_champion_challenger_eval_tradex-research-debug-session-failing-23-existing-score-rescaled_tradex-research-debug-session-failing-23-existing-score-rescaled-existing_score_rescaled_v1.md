...
- family_id: `tradex-research-debug-session-failing-23-existing-score-rescaled`
- baseline_run_id: `tradex-research-debug-session-failing-23-existing-score-rescaled-baseline`
- candidate_run_id: `tradex-research-debug-session-failing-23-existing-score-rescaled-existing_score_rescaled_v1`
- report_path: `C:/work/meemee-screener/docs/reports/tradex_champion_challenger_eval_tradex-research-debug-session-failing-23-existing-score-rescaled_tradex-research-debug-session-failing-23-existing-score-rescaled-existing_score_rescaled_v1.md`
- evaluation_window_id: `3a3f07dcdfea2840`
