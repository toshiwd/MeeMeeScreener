...
- family_id: `tradex-research-d1x-readiness-aware`
- baseline_run_id: `tradex-research-d1x-readiness-aware-baseline`
- candidate_run_id: `tradex-research-d1x-readiness-aware-readiness_aware_v1`
- report_path: `C:/work/meemee-screener/docs/reports/tradex_champion_challenger_eval_tradex-research-d1x-readiness-aware_tradex-research-d1x-readiness-aware-readiness_aware_v1.md`
- evaluation_window_id: `1276461ca1badb41`
