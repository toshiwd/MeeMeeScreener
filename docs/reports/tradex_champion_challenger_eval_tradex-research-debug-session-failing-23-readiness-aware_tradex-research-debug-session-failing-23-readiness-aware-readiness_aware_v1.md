...
- family_id: `tradex-research-debug-session-failing-23-readiness-aware`
- baseline_run_id: `tradex-research-debug-session-failing-23-readiness-aware-baseline`
- candidate_run_id: `tradex-research-debug-session-failing-23-readiness-aware-readiness_aware_v1`
- report_path: `C:/work/meemee-screener/docs/reports/tradex_champion_challenger_eval_tradex-research-debug-session-failing-23-readiness-aware_tradex-research-debug-session-failing-23-readiness-aware-readiness_aware_v1.md`
- evaluation_window_id: `887e7fb90f158836`
