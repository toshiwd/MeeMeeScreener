...
- family_id: `tradex-research-debug-session-failing-23-penalty-first`
- baseline_run_id: `tradex-research-debug-session-failing-23-penalty-first-baseline`
- candidate_run_id: `tradex-research-debug-session-failing-23-penalty-first-penalty_first_v1`
- report_path: `C:/work/meemee-screener/docs/reports/tradex_champion_challenger_eval_tradex-research-debug-session-failing-23-penalty-first_tradex-research-debug-session-failing-23-penalty-first-penalty_first_v1.md`
- evaluation_window_id: `0baff5af2df9a638`
