...
- random_seed: `29`
- manifest_hash: `755bc435be2b7ded88b979117500721e39b8257f0a06790ec6949afb740ae097`
...
- future_ret20 stage counts: before_guard=`890` / after_guard=`890` / joinable=`890` / compare_emitted=`890` / retained=`890`
...
- future_ret20_failure_reason_counts_by_source_mode: `{"precomputed": {"ret20_source_missing": 290}}`
- ret20_source_mode: `precomputed`
...
- future_ret20_join_gap_coverage: `{"after_scope_filter_count": 580, "candidate_rows_after_scope_filter": 1780, "candidate_rows_before_scope_filter": 20000, "examples": [], "future_rows_after_scope_filter": 171720, "future_rows_before_scope_filter": 3378840, "joinable_code_date_pairs_after_scope": 3560, "joinable_code_date_pairs_before_scope": 40000, "reason_counts": {}}`
...
- run_id: `tradex-research-scope-4b4fa6ccb028-seed-29-champion-baseline`
