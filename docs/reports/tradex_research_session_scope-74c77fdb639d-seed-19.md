...
- random_seed: `19`
- manifest_hash: `f2448c584a2ed7b8129c480bea7fe41053f1e274b764d991c07bca1f91e5e337`
...
- future_ret20: candidate_day_count=`445`, passed_count=`445`, guarded_out_count=`0`
- future_ret20_failure_reason_counts: `{"candidate_scope_key_mismatch": 95}`
- ret20_source_mode: `derived_from_daily_bars`
...
- future_ret20_join_gap_coverage: `{"after_scope_filter_count": 190, "candidate_rows_after_scope_filter": 890, "candidate_rows_before_scope_filter": 10000, "examples": [], "future_rows_after_scope_filter": 77740, "future_rows_before_scope_filter": 1091660, "joinable_code_date_pairs_after_scope": 0, "joinable_code_date_pairs_before_scope": 0, "reason_counts": {}}`

## Champion

- method_title: `現行ランキング`
- method_thesis: `現行のTRADEX標準順位をそのまま再現する。`
- run_id: `tradex-research-scope-74c77fdb639d-seed-19-champion-baseline`
