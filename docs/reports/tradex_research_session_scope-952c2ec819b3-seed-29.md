...
- session_id: `scope-952c2ec819b3-seed-29`
- session_scope_id: `rr_confirmed_20260323_fix5_regime_shift`
- random_seed: `29`
- manifest_hash: `a7299f85c88fe7d68daafcd1009181bee636c234a9146a6d482985637bf0d968`
...
- future_ret20_join_gap_coverage: `{"after_scope_filter_count": 540, "candidate_rows_after_scope_filter": 0, "candidate_rows_before_scope_filter": 0, "examples": [], "future_rows_after_scope_filter": 37728, "future_rows_before_scope_filter": 2628810, "joinable_code_date_pairs_after_scope": 0, "joinable_code_date_pairs_before_scope": 0, "reason_counts": {}}`
...
- run_id: `tradex-research-scope-952c2ec819b3-seed-29-champion-baseline`
...
| penalty-first | 減点優先型厳しめ | 0.0000 | 0.0000 | 0.0000 | true |
- 名前: `減点優先型厳しめ`
  - 仮説: `さらに閾値を上げて、弱い候補を上位に残しにくくする。`
  - 強い局面: `evaluation_summary.windows` を参照
  - 弱い局面: `none`
  - champion との差分: `0.0000`
