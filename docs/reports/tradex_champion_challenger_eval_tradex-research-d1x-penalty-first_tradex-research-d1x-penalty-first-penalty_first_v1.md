...
- family_id: `tradex-research-d1x-penalty-first`
- baseline_run_id: `tradex-research-d1x-penalty-first-baseline`
- candidate_run_id: `tradex-research-d1x-penalty-first-penalty_first_v1`
- report_path: `C:/work/meemee-screener/docs/reports/tradex_champion_challenger_eval_tradex-research-d1x-penalty-first_tradex-research-d1x-penalty-first-penalty_first_v1.md`
- evaluation_window_id: `d1513cdf30df694b`
