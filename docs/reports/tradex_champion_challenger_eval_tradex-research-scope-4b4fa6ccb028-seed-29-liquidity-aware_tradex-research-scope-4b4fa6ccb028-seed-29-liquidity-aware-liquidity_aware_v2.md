...
- family_id: `tradex-research-scope-4b4fa6ccb028-seed-29-liquidity-aware`
- baseline_run_id: `tradex-research-scope-4b4fa6ccb028-seed-29-liquidity-aware-baseline`
- candidate_run_id: `tradex-research-scope-4b4fa6ccb028-seed-29-liquidity-aware-liquidity_aware_v2`
- report_path: `C:/work/meemee-screener/docs/reports/tradex_champion_challenger_eval_tradex-research-scope-4b4fa6ccb028-seed-29-liquidity-aware_tradex-research-scope-4b4fa6ccb028-seed-29-liquidity-aware-liquidity_aware_v2.md`
- evaluation_window_id: `25cfa72534a1f3f3`
- regime_tag: `multi_regime`
- baseline_method_title: `現行ランキング`
- candidate_method_title: `流動性ふるい残し厳しめ`
...
- challenger_method: `流動性ふるい残し厳しめ`
- challenger_family: `liquidity-aware`
- challenger_thesis: `流動性への寄せを強めて、上位に買いにくい銘柄を残しにくくする。`
