...
binaries = []
hiddenimports = ['uvicorn', 'uvicorn.lifespan.on', 'uvicorn.protocols.http.h11_impl', 'uvicorn.protocols.websockets.websockets_impl', 'pythonnet', 'clr', 'clr_loader', 'System', 'webview.platforms.winforms', 'app.backend', 'app.backend.main', 'app.core', 'app.core.config']
