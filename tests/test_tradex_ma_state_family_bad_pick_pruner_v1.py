...
from scripts.tradex_ma_state_family_bad_pick_pruner_v1 import (
    MAX_TOTAL_PENALTY,
...
def test_pruner_smoke_run_writes_required_artifacts(tmp_path: Path) -> None:
    ...
    result = run_ma_state_family_bad_pick_pruner_v1(
    ...
    required_files = (
        "run_manifest.json",
        "ma_state_family_bad_pick_pruner_v1_compare.json",
        "ma_state_family_bad_pick_pruner_v1_decision.json",
    ...
    compare = json.loads((session_dir / "ma_state_family_bad_pick_pruner_v1_compare.json").read_text(encoding="utf-8"))
    decision = json.loads((session_dir / "ma_state_family_bad_pick_pruner_v1_decision.json").read_text(encoding="utf-8"))
    ...
    assert compare["schema_version"] == "tradex_ma_state_family_bad_pick_pruner_v1_compare_v1"
