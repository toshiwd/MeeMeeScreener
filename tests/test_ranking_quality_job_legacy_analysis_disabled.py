...
def test_ranking_quality_manual_api_is_disabled_when_legacy_analysis_disabled(monkeypatch, tmp_path) -> None:
    ...
    response = client.post("/api/jobs/quality/ranking-analysis")
