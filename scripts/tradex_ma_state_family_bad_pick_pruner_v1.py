...
DEFAULT_OUTPUT_ROOT = Path(r"G:\Tradex\ma_state_family_bad_pick_pruner_v1")
DEFAULT_LIMIT_ANCHOR_DATES = None

SCHEMA_VERSION = "tradex_ma_state_family_bad_pick_pruner_v1"
COMPARE_SCHEMA_VERSION = "tradex_ma_state_family_bad_pick_pruner_v1_compare_v1"
DECISION_SCHEMA_VERSION = "tradex_ma_state_family_bad_pick_pruner_v1_decision_v1"
MANIFEST_SCHEMA_VERSION = "tradex_ma_state_family_bad_pick_pruner_v1_manifest_v1"
MONTHLY_SCHEMA_VERSION = "tradex_ma_state_family_bad_pick_pruner_v1_monthly_comparison_v1"
REGIME_SCHEMA_VERSION = "tradex_ma_state_family_bad_pick_pruner_v1_regime_comparison_v1"
PENALTY_COVERAGE_SCHEMA_VERSION = "tradex_ma_state_family_bad_pick_pruner_v1_penalty_coverage_v1"
...
def _progress_log(message: str) -> None:
    print(f"[ma_state_family_bad_pick_pruner_v1] {message}", file=sys.stderr, flush=True)
...
def _classify_penalty(row: pd.Series) -> tuple[float, list[str], bool]:
    ...
    if bool(row.get("bad_pick_watch_family")):
        penalty -= 0.06
    ...
    if bool(row.get("mae_risk_family")):
        penalty -= 0.04
        reasons.append("mae_risk_family")
    if bool(row.get("endpoint_bad_pick_family")):
        penalty -= 0.03
    ...
    *,
    ...
    return {
        ...
        "penalty_formula": {
            ...
            "relaxed_bad_pick_family": -0.12,
            "bad_pick_watch_family": -0.06,
            "regime_bad_pick_family_if_regime_matches": -0.08,
            "mae_risk_family": -0.04,
            "endpoint_bad_pick_family": -0.03,
...
def run_ma_state_family_bad_pick_pruner_v1(
    *,
    ...
    _progress_log(
        f"start source_family={source_family_session_path} candidate_input={candidate_input_path} out_root={output_root_path} session={session_id}"
    )
    ...
    output_files = {
        ...
        "ma_state_family_bad_pick_pruner_v1_compare_json": session_tmp / "ma_state_family_bad_pick_pruner_v1_compare.json",
        "ma_state_family_bad_pick_pruner_v1_decision_json": session_tmp / "ma_state_family_bad_pick_pruner_v1_decision.json",
    ...
    _write_json(output_files["ma_state_family_bad_pick_pruner_v1_compare_json"], compare_payload)
    _write_json(output_files["ma_state_family_bad_pick_pruner_v1_decision_json"], decision_payload)
...
def main(argv: list[str] | None = None) -> int:
    ...
    run_ma_state_family_bad_pick_pruner_v1(
