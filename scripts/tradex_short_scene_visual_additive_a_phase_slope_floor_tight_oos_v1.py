...
DEFAULT_OUTPUT_ROOT = Path("G:/Tradex/short_scene_visual_additive_a_phase_slope_floor_tight_oos_v1")
MA20_SLOPE_10_FLOOR_TIGHT = -0.005
...
def run_probe(*, db_path: Path, output_root: Path, start_dt: int, end_dt: int, max_codes: int | None = None) -> dict[str, Any]:
    output_dir = output_root / f"{_now_tag()}-short_scene_visual_additive_a_phase_slope_floor_tight_oos_v1"
    ...
    result = {
        "schema_version": "tradex_short_scene_visual_additive_a_phase_slope_floor_tight_oos_v1",
        ...
        "fixed_evaluation_conditions": {
            ...
            "changed_axis": "a_phase_ma20_slope_10_floor_tight_only",
            "selection_rule": "filter ma20_slope_10 >= -0.005, then at most one outside-gap candidate per sell-candidate date ranked by lower ma20_slope_10",
        ...
        "observed_branching": {
            ...
            "selection_divergence_reason": "historical_oos_outside_gap_a_phase_candidate_added_only_when_ma20_slope_10_floor_tight_passes",
        },
    ...
    compare_path = output_dir / "short_scene_visual_additive_a_phase_slope_floor_tight_oos_compare.json"
    decision_path = output_dir / "short_scene_visual_additive_a_phase_slope_floor_tight_oos_decision.json"
    monthly_path = output_dir / "short_scene_visual_additive_a_phase_slope_floor_tight_oos_monthly.json"
    ledger_path = output_dir / "short_scene_visual_additive_a_phase_slope_floor_tight_oos_ledger.jsonl"
    result["artifacts"] = {
