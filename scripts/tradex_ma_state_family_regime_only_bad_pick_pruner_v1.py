...
DEFAULT_OUTPUT_ROOT = Path(r"G:\Tradex\ma_state_family_regime_only_bad_pick_pruner_v1")
...
SCHEMA_VERSION = "tradex_ma_state_family_regime_only_bad_pick_pruner_v1"
COMPARE_SCHEMA_VERSION = "tradex_ma_state_family_regime_only_bad_pick_pruner_v1_compare_v1"
DECISION_SCHEMA_VERSION = "tradex_ma_state_family_regime_only_bad_pick_pruner_v1_decision_v1"
MANIFEST_SCHEMA_VERSION = "tradex_ma_state_family_regime_only_bad_pick_pruner_v1_manifest_v1"
MONTHLY_SCHEMA_VERSION = "tradex_ma_state_family_regime_only_bad_pick_pruner_v1_monthly_comparison_v1"
REGIME_SCHEMA_VERSION = "tradex_ma_state_family_regime_only_bad_pick_pruner_v1_regime_comparison_v1"
PENALTY_COVERAGE_SCHEMA_VERSION = "tradex_ma_state_family_regime_only_bad_pick_pruner_v1_penalty_coverage_v1"

TOP_K_VALUES = (5, 10, 20)
REGIME_ONLY_PENALTY = -0.08
...
def _progress_log(message: str) -> None:
    print(f"[ma_state_family_regime_only_bad_pick_pruner_v1] {message}", file=sys.stderr, flush=True)
...
def _classify_penalty(row: pd.Series) -> tuple[float, list[str], bool]:
    regime_match = bool(row.get("regime_bad_pick_family")) and str(row.get("family_regime_context") or "") == str(row.get("family_bad_pick_regime") or "")
    if regime_match:
        return float(REGIME_ONLY_PENALTY), ["regime_bad_pick_family", "regime_only_match"], True
    return 0.0, [], False
...
def _build_compare_payload(
    *,
    ...
    topk_summary = {
        ...
        "selection_divergence_reason": "regime_only_bad_pick_pruner_v1_vs_champion",
    ...
    return {
        ...
        "penalty_formula": {
            "regime_bad_pick_family_if_regime_matches": REGIME_ONLY_PENALTY,
            "family_bad_pick_regime_extraction": REGIME_BAD_PICK_REGIME_EXTRACTION,
            "max_total_penalty": MAX_TOTAL_PENALTY,
            "note": "regime-only penalty uses dominant_regime_context extracted from the family row artifact",
        },
        "penalty_coverage": {},
...
def _build_v1_v1_1_regime_only_delta_payload(
    *,
    ...
    return {
        "schema_version": "tradex_ma_state_family_regime_only_bad_pick_pruner_v1_delta_v1",
        "generated_at": _utc_now(),
        ...
        "regime_only_extraction": REGIME_BAD_PICK_REGIME_EXTRACTION,
...
def run_ma_state_family_regime_only_bad_pick_pruner_v1(
    *,
    ...
    output_files = {
        ...
        "ma_state_family_regime_only_bad_pick_pruner_v1_compare_json": session_tmp / "ma_state_family_regime_only_bad_pick_pruner_v1_compare.json",
        "ma_state_family_regime_only_bad_pick_pruner_v1_decision_json": session_tmp / "ma_state_family_regime_only_bad_pick_pruner_v1_decision.json",
        "v1_v1_1_regime_only_delta_json": session_tmp / "v1_v1_1_regime_only_delta.json",
    ...
    regime_only_delta_payload = _build_v1_v1_1_regime_only_delta_payload(
    ...
    _write_json(output_files["ma_state_family_regime_only_bad_pick_pruner_v1_compare_json"], compare_payload)
    _write_json(output_files["ma_state_family_regime_only_bad_pick_pruner_v1_decision_json"], decision_payload)
    _write_json(output_files["v1_v1_1_regime_only_delta_json"], regime_only_delta_payload)
    ...
    return {
        ...
        "v1_v1_1_regime_only_delta": regime_only_delta_payload,
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run TRADEX regime-only bad-pick pruner against the refined family map.")
    ...
    run_ma_state_family_regime_only_bad_pick_pruner_v1(
