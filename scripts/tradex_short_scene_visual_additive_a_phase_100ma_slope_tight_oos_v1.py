...
DEFAULT_OUTPUT_ROOT = Path("G:/Tradex/short_scene_visual_additive_a_phase_100ma_slope_tight_oos_v1")
REQUIRED_SHAPE_INTENT = "a_phase_downtrend_100ma_rejection"
...
def _apply_100ma_rejection(events: list[dict[str, Any]]) -> list[dict[str, Any]]:
    return [event for event in events if event.get("shape_intent") == REQUIRED_SHAPE_INTENT]


def run_probe(*, db_path: Path, output_root: Path, start_dt: int, end_dt: int, max_codes: int | None = None) -> dict[str, Any]:
    output_dir = output_root / f"{_now_tag()}-short_scene_visual_additive_a_phase_100ma_slope_tight_oos_v1"
    ...
    filtered_candidates = _apply_100ma_rejection(slope_floor_candidates)
    ...
    coverage = {
        ...
        "shape_filtered_candidate_count": len(filtered_candidates),
    ...
    result = {
        "schema_version": "tradex_short_scene_visual_additive_a_phase_100ma_slope_tight_oos_v1",
        ...
        "fixed_evaluation_conditions": {
            ...
            "changed_axis": "a_phase_100ma_rejection_plus_ma20_slope_10_floor_tight",
            "selection_rule": "filter ma20_slope_10 >= -0.005 and shape_intent == a_phase_downtrend_100ma_rejection, then at most one outside-gap candidate per sell-candidate date ranked by lower ma20_slope_10",
        ...
        "observed_branching": {
            ...
            "selection_divergence_reason": "historical_oos_outside_gap_a_phase_candidate_added_only_when_100ma_rejection_and_slope_tight_pass",
        },
    ...
    compare_path = output_dir / "short_scene_visual_additive_a_phase_100ma_slope_tight_oos_compare.json"
    decision_path = output_dir / "short_scene_visual_additive_a_phase_100ma_slope_tight_oos_decision.json"
    monthly_path = output_dir / "short_scene_visual_additive_a_phase_100ma_slope_tight_oos_monthly.json"
    ledger_path = output_dir / "short_scene_visual_additive_a_phase_100ma_slope_tight_oos_ledger.jsonl"
    result["artifacts"] = {
